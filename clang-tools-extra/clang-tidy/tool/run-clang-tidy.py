...
def main():
    ...
    parser.add_argument(
        ...
        default=None,
        help="Using Regular expression to match names of "
        "headers that will be excluded from diagnostics and analysis."
        " Main file diagnostic translation units are always displayed.",
    )
    parser.add_argument(
        "-header-filter",
        default=None,
